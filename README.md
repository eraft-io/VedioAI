...
由于 macOS 的安全机制，首次安装应用可能会提示"无法打开，因为无法验证开发者"。解决方法：

**方法 1：使用终端命令（推荐）**
```bash
sudo xattr -cr /Applications/VideoSubtitle.app
```

**方法 2：通过系统设置**
1. 打开"系统设置" → "隐私与安全性"
2. 在"安全性"部分找到"已阻止使用 VideoSubtitle"
3. 点击"仍要打开"

**方法 3：首次启动时按住 Control 键**
1. 在"应用程序"文件夹中找到 VideoSubtitle
